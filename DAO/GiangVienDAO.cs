   ...
   public  class GiangVienDAO
    {
        ...
        {
            int res = DataProvider.Instance.ExecuteNonQuery("exec ChinhsuaGiangVien @ma , @ten  ,  @sdt , @email  , @mangdung  ", new object[] { man, ten,sdt,email,manguoidung });
            return res > 0;
        }
        ...
        {
            int res = DataProvider.Instance.ExecuteNonQuery("exec XoasuaGiangVien  @ma   ", new object[] { man });
            return res > 0;
        }
